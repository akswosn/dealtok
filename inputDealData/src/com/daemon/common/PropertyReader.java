...
public class PropertyReader
{
	...
	public PropertyReader() throws Exception {
		this(Constant.SAFETY_INFOMATION_PROPERTY_PATH);
	}
	 ...
	 */
	public PropertyReader(String sFileName) throws Exception {
	...
	public static PropertyReader getInstance() {
		return getInstance(Constant.SAFETY_INFOMATION_PROPERTY_PATH);
	}

	public static PropertyReader getInstance(String sFileName) {
		if(instance == null) {
			try {
				instance = new PropertyReader(sFileName);
			}
			catch(Exception e) {
				//				e.printStackTrace();
			}
